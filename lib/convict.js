/*
 * node-convict
 * Configuration management with support for environmental variables, file loading, validation, and sanity checking.
 *
 */
...
var types = {
  int: function(x) {
    check(x, 'must be an integer');
  },
  nat: function(x) {
    check(x, 'must be a positive integer');
  },
  port: function(x) {
    check(x, 'Ports must be within range 1 - 65535');
  },
  url: function(x) {
    check(x, 'must be a URL');
  },
  email: function(x) {
    check(x, 'must be an email address');
  },
  ipaddress: function(x) {
    check(x, 'must be an IP address');
  },
  duration: function(x) {
    check(x, 'must be a positive integer');
  },
