...
function normalizeSchema(name, node, props, fullName, provider, env, argv, sensitive) {
  ...
  if (o.provider) {
    ...
    provider[o.provider].push(fullName);
  }
...
function importProvider(o) {
  if(o.externalProvider.get){
    Object.keys(o._provider).forEach(function(externalString) {
      let k = o._provider[externalString];
      if (o.externalProvider.get(externalString)) {
        o.set(k, String(o.externalProvider.get(externalString)));
      }
    });
  }
}
...
let convict = function convict(def) {
  ...
  let rv = {
    ...
    addProvider: function(provider) {
      let self = this;
      self.externalProvider.get = provider;
      return this;
    },
