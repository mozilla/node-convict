  ...
  describe('after being parsed', function() {
    ...
    describe('.default()', function() {
      ...
      it('must throw if key doesn\'t exist', function() {
        expect(() => myOwnConf.default('foo.no')).to.throw("cannot find configuration param 'foo.properties.no.default'");
      });
      ...
      describe('when acting on an Object property', function() {
        ...
        it('must not be altered by calls to .set()', function() {
          ...
          expect(myOwnConf.default('someObject')).to.deep.equal({});
          expect(() => myOwnConf.default('someObject.five')).to.throw("cannot find configuration param 'someObject.properties.five.default'");
        });
    ...
    describe('.reset()', function() {
      ...
      it('must throw if key doesn\'t exist', function() {
        expect(() => myOwnConf.reset('foo.no')).to.throw("cannot find configuration param 'foo.properties.no.default'");
      });
    });
